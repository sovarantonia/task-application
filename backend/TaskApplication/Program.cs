...
User user = new User(Guid.Parse("c1a4d379-90c1-4e25-bbe2-9a413f0f2c67"), "Alice Morgan", "alice.morgan@example.com", "Backend Development");
dbService.Save(user);
...
TaskApplication.entity.Task task = new TaskApplication.entity.Task
    ...
    new DateOnly(2025, 6, 6), user.Id, (int) Status.InProgress);
