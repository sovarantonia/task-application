...
//    {
//        var task = new TaskApplication.entity.Task
//        {
//            Title = "First task",
...
//        cookieContainer.SetCookies(uri, "email=admin@admin.com");
//        var message = new HttpRequestMessage(HttpMethod.Post, "/Task/");
//        message.Headers.Add("Cookie", "email=admin@admin.com");

//        var res = await client.PostAsJsonAsync("/Task/", task);
